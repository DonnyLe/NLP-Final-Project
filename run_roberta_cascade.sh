...
#SBATCH --job-name=roberta_cascade
#SBATCH --mem=16GB
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/roberta_cascade_%j.out
#SBATCH --error=logs/roberta_cascade_%j.err

echo "=========================================="
echo " RoBERTa-LARGE CASCADED BINARY (HC vs Non-HC, MCI vs Dementia) "
echo " Module: bert.bert_cascaded_binary "
echo "=========================================="
...
# -------------------------------------------
echo "=========================================="
echo " RUNNING roberta_large_cascade.roberta_cascade (RoBERTa-large) "
echo "=========================================="
...
python -m roberta_large_cascade.roberta_cascade
